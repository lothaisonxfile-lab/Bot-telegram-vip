...
async def mute_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        permissions = ChatPermissions(can_send_messages=False, can_send_media_messages=False, can_send_polls=False, can_send_other_messages=False, can_add_web_page_previews=False)
...
def main():
    # Chạy Web Server giả lập ở chế độ ngầm để Render không tắt bot
